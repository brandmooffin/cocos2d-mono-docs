...
You can download the complete Part 1 project [here](https://github.com/Cocos2D-Mono/cocos2d-mono-samples/tree/main/Tutorial%20Samples/Platformer/Checkpoints/Part%201) to compare with your implementation or use as a starting point.
