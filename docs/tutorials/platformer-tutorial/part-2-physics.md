...
You can download the complete Part 2 project [here](https://github.com/Cocos2D-Mono/cocos2d-mono-samples/tree/main/Tutorial%20Samples/Platformer/Checkpoints/Part%202) to compare with your implementation.
